...
var L3ChainComponent = /** @class */ (function () {
    function L3ChainComponent(provider, chainName) {
        ...
        if (!core_1.ChainNames.includes(chainName)) {
            (0, core_1.registerChain)(chainName, provider.chainIdentifier);
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sentLog = web3.eth.abi.decodeLog(abis_2.default.IChain.find(function (item) { return item.name == 'SentL3Transaction'; }).inputs, sourceReceipt.logs.find(function (log) { return log.logIndex == logIndex; }).data, sourceReceipt.logs.find(function (log) { return log.logIndex == logIndex; }).topics.slice(1));

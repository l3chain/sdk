...
var L3Chain = /** @class */ (function () {
    ...
    L3Chain.prototype.getBlockNumber = function (onChain) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.components[onChain].contract.methods.getBlockNumber().call()];
            });
        });
    };
    L3Chain.prototype.getBlockNumberAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var chainNames, blockNumbers, _i, chainNames_1, chainName, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        chainNames = Object.keys(this.components);
                        blockNumbers = {};
                        _i = 0, chainNames_1 = chainNames;
                        _c.label = 1;
                    case 1:
                        if (!(_i < chainNames_1.length)) return [3 /*break*/, 4];
                        chainName = chainNames_1[_i];
                        _a = blockNumbers;
                        _b = chainName;
                        return [4 /*yield*/, this.getBlockNumber(chainName)];
                    case 2:
                        _a[_b] = _c.sent();
                        _c.label = 3;
                    case 3:
    ...
    L3Chain.prototype.getEpochConfigAtIndex = function (epochIndex, onChain) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.components[onChain].contract.methods.getEpochConfigAtIndex(epochIndex).call()];
            });
        });
    };
    L3Chain.prototype.getBlockByNumber = function (blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var block;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        block = _a.sent();
                        return [2 /*return*/, this.getBlockByHash(block.hash)];
                }
            });
        });
    };
    L3Chain.prototype.getBlockByHash = function (blockHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    L3Chain.prototype.getBlockProposeds = function (blockHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.components.HOST.graphClient.query(GQL.getBlockProposeds(blockHash))];
            });
        });
    };
    L3Chain.prototype.getTransactionHeads = function (fromChain, transactionHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.components.HOST.graphClient.query(GQL.getTransactionHeads(core_1.ChainIdentifiers[fromChain], transactionHash)).then(function (rsp) { return rsp.transactionHeads; })];
            });
        });
    };
    L3Chain.prototype.getTransactionHead = function (fromChain, transactionHash, sourceTransactionDataHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    L3Chain.prototype.getL3TransactionProof = function (fromChain, transactionHash, logIndex) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getTransactionHead(fromChain, transactionHash, sourceTransactionDataHash)];
                    case 2:
                        headIndex = _a.sent();
                        return [4 /*yield*/, this.getBlockByHash(headIndex.blockHash)];
                    case 3:
                        block = _a.sent();
